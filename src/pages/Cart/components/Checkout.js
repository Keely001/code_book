...
export const Checkout = ({ setCheckout }) => {
  // Destructure cartList, total, and clearCart from useCart hook
  ...
  async function handleOrderSubmit(event) {
    ...
    try {
      // Create order and clear the cart on success
      const data = await createOrder(cartList, total, user);
      clearCart();
      // Navigate to order summary page with success status
  ...
  // Return the JSX structure of the Checkout component
  return (
    <section>
      {/* Overlay background */}
