...
export const Hero = () => {
    return (
      // Main section with flex display, responsive design for dark mode and light mode
      <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
          ...
          <div className="text my-5">
              ...
              <p className="text-2xl my-7 px-1 dark:text-slate-300">
                e_CodeBook is the world's most popular and authoritative source for computer science ebooks. Find ratings and access to the newest books digitally.
              </p>
