...
export const Faq = () => {
  // Array of FAQ objects with id, question, and answer properties
  const faqs = [
    {
      id: 1,
  ...
  return (
    // Main section container with margin, padding, border, and shadow styling
    <section className="my-10 p-7 border rounded dark:border-slate-700 shadow-sm">
      ...
      {/* Accordion container with data attributes for collapse behavior */}
      <div 
        id="accordion-flush" 
      ...
      >
        {/* Mapping over FAQs to render each accordion item */}
        {faqs.map((faq) => (
